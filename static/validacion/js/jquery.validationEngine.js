 ...
 */
 (function($) {
	 ...
	 var methods = {
			...
			for (var i = 0, field_errors = 0; i < rules.length; i++) {
				...
				switch (rules[i]) {
					...
					case "future":
						...
						break;
					case "validarCedula":
						errorMsg = methods._getErrorMessage(form, field,rules[i], rules, i, options, methods._validarCedula);
						break;
					case "dateRange":
						var classGroup = "["+options.validateAttribute+"*=" + rules[i + 1] + "]";
		...
		* @return an error string if validation failed
		*/
		_validarCedula: function(field, rules, i, options ) {
			//var form = field.closest("form, .validationEngineContainer");
			//var name = field.attr("name");
			var ced = field.val();
			var logro = check_cedula(ced);
			return logro;
		},
   ...
   if ( num == 10 )
   {
     ...
     else
     {
       //alert( "La c\xe9dula NO es v\xe1lida!!!" );
    	 return "La c\xe9dula NO es v\xe1lida!!!";
       //return false;
     }
   }
   else
